$( function() {
   ...
   var gamePlatformModel = Backbone
   
   var gameItemsCollection = Backbone.Collection.extend({
       model: gameItemModel
   });
   
   var gameItems = new gameItemsCollection;
   ...
   gameItems.add({
     ...
     * @param {Integer} min
     * @param {Integer} max
     * @return {integer} Calculated random number
     */
